...
import weight_sharing_or as ws
...
if __name__ == "__main__":
    ...
    np.savez(f'or_iters{ITERATIONS}.npz',
             comb=combinations,
             ...
             act=activations,
             pi=perfect_iters)
    # np.savez('weight_sharing_or.npz', miscl=misclassified, cl=classes, w=weights, l=losses, act=activations)
